...
public class InsThirdQuestion extends HttpServlet {
...
//			 updateEntity.getProperty("name").toString()
			...
			updateEntity.setProperty("secondquestion", "0");
		}
		
		updateEntity.setProperty("thrdquestion", number);
		dss.put(updateEntity);
		
		resp.setContentType("text/plain");
		resp.getWriter().println(id.toString());
		
		resp.sendRedirect("/lastmessage");
	}
}
